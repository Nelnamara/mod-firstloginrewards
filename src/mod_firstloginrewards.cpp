...
- v2024.07.16 - Custom items added and code simplified for use of reward custom bags
    ...
    void OnFirstLogin(Player* player)
    {
        ...
        if (sConfigMgr->GetOption<bool>("FirstLogin.Enable", true))
        {
            ...
            if (sConfigMgr->GetOption<bool>("FirstLogin.BoA", true))
            {
                ...
                // Define Equipment
                uint32 shoulders = 0, chest = 0, trinket = 0, weapon = 0, weapon2 = 0, weapon3 = 0, shoulders2 = 0, chest2 = 0, trinket2 = 0, supplybag = 1;
            ...
            if (sConfigMgr->GetOption<bool>("FirstLogin.SpecialAbility", true))
            {
                ...
                // Add a few extra items
		            player->AddItem(90007, 2);	// Welcome "Convention" Goody Bag
		          player->AddItem(90020, 1);	// Engineering Contraband :)
